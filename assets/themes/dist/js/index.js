...
/***/ function(module, exports, __webpack_require__) {
	...
	var a = function () {
	    function a() {
	        e.on("click", b), d.on("click", function (a) {
	            a.stopPropagation();
	        });
	    }
	    ...
	    function c(a) {
	        d.eq(g).removeClass("mainmenu-open"), g = -1;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module) {"use strict";var _defineProperties=__webpack_require__(77);var _defineProperties2=_interopRequireDefault(_defineProperties);var _typeof2=__webpack_require__(38);var _typeof3=_interopRequireDefault(_typeof2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/*!
	...
	if((typeof key==="undefined"?"undefined":(0,_typeof3.default)(key))==="object"){return this.each(function(){data_user.set(this,key);});}return access(this,function(value){var data,camelKey=jQuery.camelCase(key);// The calling jQuery object (element matches) is not empty
	...
	div.innerHTML="<textarea>x</textarea>";support.noCloneChecked=!!div.cloneNode(true).lastChild.defaultValue;})();var strundefined= true?"undefined":(0,_typeof3.default)(undefined);support.focusinBubbles="onfocusin"in window;var rkeyEvent=/^key/,rmouseEvent=/^(?:mouse|pointer|contextmenu)|click/,rfocusMorph=/^(?:focusinfocus|focusoutblur)$/,rtypenamespace=/^([^.]*)(?:\.(.+)|)$/;function returnTrue(){return true;}function returnFalse(){return false;}function safeActiveElement(){try{return document.activeElement;}catch(err){}}/*
	...
	return(typeof jQuery==="undefined"?"undefined":(0,_typeof3.default)(jQuery))!==strundefined&&jQuery.event.triggered!==e.type?jQuery.event.dispatch.apply(elem,arguments):undefined;};}// Handle multiple events separated by a space
	...
	if((0,_typeof3.default)(elem.getAttribute)===strundefined){return jQuery.prop(elem,name,value);}// All attributes are lowercase
	...
	if((typeof noGlobal==="undefined"?"undefined":(0,_typeof3.default)(noGlobal))===strundefined){window.jQuery=window.$=jQuery;}return jQuery;});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(15), 'Object', {defineProperties: __webpack_require__(21)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	- Modernizr 2.6.1 Custom Build (http://modernizr.com/) (Named Modernizr for Sequence to prevent conflicts)
		...
		*/(function (e) {
		function n(n, r, i, s) {
			function f() {
				o.afterLoaded();o.settings.hideFramesUntilPreloaded && o.settings.preloader !== undefined && o.settings.preloader !== !1 && o.frames.show();if (o.settings.preloader !== undefined && o.settings.preloader !== !1) {
					if (o.settings.hidePreloaderUsingCSS && o.transitionsSupported) {
						o.prependPreloadingCompleteTo = o.settings.prependPreloadingComplete === !0 ? o.settings.preloader : e(o.settings.prependPreloadingComplete);o.prependPreloadingCompleteTo.addClass("preloading-complete");setTimeout(g, o.settings.hidePreloaderDelay);
					} else o.settings.preloader.fadeOut(o.settings.hidePreloaderDelay, function () {
						clearInterval(o.defaultPreloader);g();
					});
				} else g();
			}function h(t, n) {
				var r = [];if (!n) for (var i = t; i > 0; i--) {
					o.frames.eq(o.settings.preloadTheseFrames[i - 1] - 1).find("img").each(function () {
						r.push(e(this)[0]);
					});
				} else for (var s = t; s > 0; s--) {
					r.push(e("body").find('img[src="' + o.settings.preloadTheseImages[s - 1] + '"]'));
				}return r;
			}function p(t, n) {
				function c() {
					var t = e(f),
					    r = e(l);s && (l.length ? s.reject(u, t, r) : s.resolve(u));e.isFunction(n) && n.call(i, u, t, r);
				}function h(t, n) {
					if (t.src === r || e.inArray(t, a) !== -1) return;a.push(t);n ? l.push(t) : f.push(t);e.data(t, "imagesLoaded", { isBroken: n, src: t.src });o && s.notifyWith(e(t), [n, u, e(f), e(l)]);if (u.length === a.length) {
						setTimeout(c);u.unbind(".imagesLoaded");
					}
				...
				function t(e, t) {
					var r, i;for (i in t) {
						i === "left" || i === "right" ? r = n[i] : r = i;e === parseFloat(r) && o._initCustomKeyEvent(t[i]);
					}
				}function r() {
					o.canvas.on("touchmove.sequence", i);u = null;f = !1;
				}function i(e) {
					o.settings.swipePreventsDefault && e.preventDefault();if (f) {
						var t = e.originalEvent.touches[0].pageX,
						    n = e.originalEvent.touches[0].pageY,
						    i = u - t,
						    s = a - n;if (Math.abs(i) >= o.settings.swipeThreshold) {
							r();i > 0 ? o._initCustomKeyEvent(o.settings.swipeEvents.left) : o._initCustomKeyEvent(o.settings.swipeEvents.right);
						} else if (Math.abs(s) >= o.settings.swipeThreshold) {
							r();s > 0 ? o._initCustomKeyEvent(o.settings.swipeEvents.down) : o._initCustomKeyEvent(o.settings.swipeEvents.up);
						}
					}
				}function s(e) {
					if (e.originalEvent.touches.length === 1) {
						u = e.originalEvent.touches[0].pageX;a = e.originalEvent.touches[0].pageY;f = !0;o.canvas.on("touchmove.sequence", i);
					}
				}e(o.settings.preloader).remove();o.nextButton = o._renderUiElements(o.settings.nextButton, ".sequence-next");o.prevButton = o._renderUiElements(o.settings.prevButton, ".sequence-prev");o.pauseButton = o._renderUiElements(o.settings.pauseButton, ".sequence-pause");o.pagination = o._renderUiElements(o.settings.pagination, ".sequence-pagination");o.nextButton !== undefined && o.nextButton !== !1 && o.settings.showNextButtonOnInit === !0 && o.nextButton.show();o.prevButton !== undefined && o.prevButton !== !1 && o.settings.showPrevButtonOnInit === !0 && o.prevButton.show();o.pauseButton !== undefined && o.pauseButton !== !1 && o.settings.showPauseButtonOnInit === !0 && o.pauseButton.show();if (o.settings.pauseIcon !== !1) {
					o.pauseIcon = o._renderUiElements(o.settings.pauseIcon, ".sequence-pause-icon");o.pauseIcon !== undefined && o.pauseIcon.hide();
				} else o.pauseIcon = undefined;if (o.pagination !== undefined && o.pagination !== !1) {
					o.paginationLinks = o.pagination.children();o.paginationLinks.on("click.sequence", function () {
						var t = e(this).index() + 1;o.goTo(t);
					});o.settings.showPaginationOnInit === !0 && o.pagination.show();
				}o.nextFrameID = o.settings.startingFrameID;if (o.settings.hashTags === !0) {
					o.frames.each(function () {
						o.frameHashID.push(e(this).prop(o.getHashTagFrom));
					});o.currentHashTag = location.hash.replace("#", "");if (o.currentHashTag === undefined || o.currentHashTag === "") o.nextFrameID = o.settings.startingFrameID;else {
						o.frameHashIndex = e.inArray(o.currentHashTag, o.frameHashID);o.frameHashIndex !== -1 ? o.nextFrameID = o.frameHashIndex + 1 : o.nextFrameID = o.settings.startingFrameID;
					}
				}o.nextFrame = o.frames.eq(o.nextFrameID - 1);o.nextFrameChildren = o.nextFrame.children();o.pagination !== undefined && e(o.paginationLinks[o.settings.startingFrameID - 1]).addClass("current");if (o.transitionsSupported) {
					if (!o.settings.animateStartingFrameIn) {
						o.currentFrameID = o.nextFrameID;o.settings.moveActiveFrameToTop && o.nextFrame.css("z-index", o.numberOfFrames);o._resetElements(o.transitionPrefix, o.nextFrameChildren, "0s");o.nextFrame.addClass("animate-in");if (o.settings.hashTags && o.settings.hashChangesOnFirstFrame) {
							o.currentHashTag = o.nextFrame.prop(o.getHashTagFrom);document.location.hash = "#" + o.currentHashTag;
						}setTimeout(function () {
							o._resetElements(o.transitionPrefix, o.nextFrameChildren, "");
						}, 100);o._resetAutoPlay(!0, o.settings.autoPlayDelay);
						...
						o._resetElements(o.transitionPrefix, o.nextFrameChildren, "0s");o.nextFrame.addClass("animate-out");o.goTo(o.nextFrameID, -1, !0);
					} else o.goTo(o.nextFrameID, 1, !0);
				} else {
					o.container.addClass("sequence-fallback");o.currentFrameID = o.nextFrameID;if (o.settings.hashTags && o.settings.hashChangesOnFirstFrame) {
						o.currentHashTag = o.nextFrame.prop(o.getHashTagFrom);document.location.hash = "#" + o.currentHashTag;
					}o.frames.addClass("animate-in");o.frames.not(":eq(" + (o.nextFrameID - 1) + ")").css({ display: "none", opacity: 0 });o._resetAutoPlay(!0, o.settings.autoPlayDelay);
				...
				var d = h(l),
				    v = h(c, !0),
				    m = e(d.concat(v));p(m, f);
			}
		}var t = !1;e(window).bind("load", function () {
			t = !0;
		});n.prototype = { startAutoPlay: function startAutoPlay(e) {
				var t = this;e = e === undefined ? t.settings.autoPlayDelay : e;t.unpause();t._resetAutoPlay();t.autoPlayTimer = setTimeout(function () {
					t.settings.autoPlayDirection === 1 ? t.next() : t.prev();
				}, e);
			}, stopAutoPlay: function stopAutoPlay() {
				var e = this;e.pause(!0);clearTimeout(e.autoPlayTimer);
			}, pause: function pause(e) {
				var t = this;if (!t.isSoftPaused) {
					if (t.pauseButton !== undefined) {
						t.pauseButton.addClass("paused");t.pauseIcon !== undefined && t.pauseIcon.show();
					}t.paused();t.isSoftPaused = !0;t.isHardPaused = e ? !0 : !1;t.isPaused = !0;t._resetAutoPlay();
				} else t.unpause();
			}, unpause: function unpause(e) {
				var t = this;if (t.pauseButton !== undefined) {
					t.pauseButton.removeClass("paused");t.pauseIcon !== undefined && t.pauseIcon.hide();
				}t.isSoftPaused = !1;t.isHardPaused = !1;t.isPaused = !1;if (!t.active) {
					e !== !1 && t.unpaused();t._resetAutoPlay(!0, t.settings.unpauseDelay);
				} else t.delayUnpause = !0;
			}, next: function next() {
				var e = this;e.nextFrameID = e.currentFrameID !== e.numberOfFrames ? e.currentFrameID + 1 : 1;e.active === !1 || e.active === undefined ? e.goTo(e.nextFrameID, 1) : e.goTo(e.nextFrameID, 1, !0);
			}, prev: function prev() {
				var e = this;e.nextFrameID = e.currentFrameID === 1 ? e.numberOfFrames : e.currentFrameID - 1;e.active === !1 || e.active === undefined ? e.goTo(e.nextFrameID, -1) : e.goTo(e.nextFrameID, -1, !0);
			}, goTo: function goTo(t, n, r) {
				var i = this;t = parseFloat(t);var s = r === !0 ? 0 : i.settings.transitionThreshold;if (t === i.currentFrameID || i.settings.navigationSkip && i.navigationSkipThresholdActive || !i.settings.navigationSkip && i.active || !i.transitionsSupported && i.active || !i.settings.cycle && n === 1 && i.currentFrameID === i.numberOfFrames || !i.settings.cycle && n === -1 && i.currentFrameID === 1 || i.settings.preventReverseSkipping && i.direction !== n && i.active) return !1;if (i.settings.navigationSkip && i.active) {
					i.navigationSkipThresholdActive = !0;i.settings.fadeFrameWhenSkipped && i.nextFrame.stop().animate({ opacity: 0 }, i.settings.fadeFrameTime);clearTimeout(i.transitionThresholdTimer);setTimeout(function () {
						i.navigationSkipThresholdActive = !1;
					}, i.settings.navigationSkipThreshold);
				}if (!i.active || i.settings.navigationSkip) {
					i.active = !0;i._resetAutoPlay();n === undefined ? i.direction = t > i.currentFrameID ? 1 : -1 : i.direction = n;i.currentFrame = i.canvas.children(".animate-in");i.nextFrame = i.frames.eq(t - 1);i.currentFrameChildren = i.currentFrame.children();i.nextFrameChildren = i.nextFrame.children();if (i.pagination !== undefined) {
						i.paginationLinks.removeClass("current");e(i.paginationLinks[t - 1]).addClass("current");
					}if (i.transitionsSupported) {
						if (i.currentFrame.length !== undefined) {
							i.beforeCurrentFrameAnimatesOut();i.settings.moveActiveFrameToTop && i.currentFrame.css("z-index", 1);i._resetElements(i.transitionPrefix, i.nextFrameChildren, "0s");if (!i.settings.reverseAnimationsWhenNavigatingBackwards || i.direction === 1) {
								i.nextFrame.removeClass("animate-out");i._resetElements(i.transitionPrefix, i.currentFrameChildren, "");
							} else if (i.settings.reverseAnimationsWhenNavigatingBackwards && i.direction === -1) {
								i.nextFrame.addClass("animate-out");i._reverseTransitionProperties();
							}
						} else i.isStartingFrame = !1;i.active = !0;i.currentFrame.unbind(i.transitionEnd);i.nextFrame.unbind(i.transitionEnd);i.settings.fadeFrameWhenSkipped && i.settings.navigationSkip && i.nextFrame.css("opacity", 1);i.beforeNextFrameAnimatesIn();i.settings.moveActiveFrameToTop && i.nextFrame.css("z-index", i.numberOfFrames);if (!i.settings.reverseAnimationsWhenNavigatingBackwards || i.direction === 1) {
							setTimeout(function () {
								i._resetElements(i.transitionPrefix, i.nextFrameChildren, "");i._waitForAnimationsToComplete(i.nextFrame, i.nextFrameChildren, "in");(i.afterCurrentFrameAnimatesOut !== "function () {}" || i.settings.transitionThreshold === !0 && r !== !0) && i._waitForAnimationsToComplete(i.currentFrame, i.currentFrameChildren, "out", !0, 1);
							}, 50);setTimeout(function () {
								if (i.settings.transitionThreshold === !1 || i.settings.transitionThreshold === 0 || r === !0) {
									i.currentFrame.toggleClass("animate-out animate-in");i.nextFrame.addClass("animate-in");
								} else {
									i.currentFrame.toggleClass("animate-out animate-in");i.settings.transitionThreshold !== !0 && (i.transitionThresholdTimer = setTimeout(function () {
							...
							setTimeout(function () {
								i._resetElements(i.transitionPrefix, i.currentFrameChildren, "");i._resetElements(i.transitionPrefix, i.nextFrameChildren, "");i._reverseTransitionProperties();i._waitForAnimationsToComplete(i.nextFrame, i.nextFrameChildren, "in");(i.afterCurrentFrameAnimatesOut !== "function () {}" || i.settings.transitionThreshold === !0 && r !== !0) && i._waitForAnimationsToComplete(i.currentFrame, i.currentFrameChildren, "out", !0, -1);
							}, 50);setTimeout(function () {
								if (i.settings.transitionThreshold === !1 || i.settings.transitionThreshold === 0 || r === !0) {
									i.currentFrame.removeClass("animate-in");i.nextFrame.toggleClass("animate-out animate-in");
								} else {
									i.currentFrame.removeClass("animate-in");i.settings.transitionThreshold !== !0 && (i.transitionThresholdTimer = setTimeout(function () {
				...
				var t = this,
				    ...
				    o = i - s,
				    u = 0,
				    a = 0;o < 0 && !t.settings.preventDelayWhenReversingAnimations ? u = Math.abs(o) : o > 0 && (a = Math.abs(o));var f = function f(n, r, i, s) {
					function o(e) {
						e = e.split(",")[0];var t = { linear: "cubic-bezier(0.0,0.0,1.0,1.0)", ease: "cubic-bezier(0.25, 0.1, 0.25, 1.0)", "ease-in": "cubic-bezier(0.42, 0.0, 1.0, 1.0)", "ease-in-out": "cubic-bezier(0.42, 0.0, 0.58, 1.0)", "ease-out": "cubic-bezier(0.0, 0.0, 0.58, 1.0)" };e.indexOf("cubic-bezier") < 0 && (e = t[e]);return e;
					}r.each(function () {
						var r = parseFloat(e(this).css(t.transitionPrefix + "transition-duration").replace("s", "")),
						    ...
						    a = e(this).css(t.transitionPrefix + "transition-timing-function");if (a.indexOf("cubic") === -1) var a = o(a);var f = a.replace("cubic-bezier(", "").replace(")", "").split(",");e.each(f, function (e, t) {
							f[e] = parseFloat(t);
						});var l = [1 - f[2], 1 - f[3], 1 - f[0], 1 - f[1]];a = "cubic-bezier(" + l + ")";var c = r + u;n["transition-duration"] = r + "s";n["transition-delay"] = i - c + s + "s";n["transition-timing-function"] = a;e(this).css(t._prefixCSS(t.transitionPrefix, n));
					});
				};f(t.transitionProperties, t.currentFrameChildren, i, u);f(t.transitionProperties, t.nextFrameChildren, s, a);
			}, _prefixCSS: function _prefixCSS(e, t) {
				var n = this,
				    r = {};for (var i in t) {
					r[e + i] = t[i];
				}return r;
			}, _resetAutoPlay: function _resetAutoPlay(e, t) {
				var n = this;if (e === !0) {
					if (n.settings.autoPlay && !n.isSoftPaused) {
						clearTimeout(n.autoPlayTimer);n.autoPlayTimer = setTimeout(function () {
							n.settings.autoPlayDirection === 1 ? n.next() : n.prev();
						}, t);
					}
				} else clearTimeout(n.autoPlayTimer);
			}, _renderUiElements: function _renderUiElements(t, n) {
				var r = this;switch (t) {case !1:
						return undefined;case !0:
						n === ".sequence-preloader" && r._defaultPreloader(r.container, r.transitionsSupported, r.animationPrefix);return e(n);default:
						return e(t);}
			}, _waitForAnimationsToComplete: function _waitForAnimationsToComplete(t, n, r, i, s) {
				var o = this;if (r === "out") var u = function u() {
					o.afterCurrentFrameAnimatesOut();o.settings.transitionThreshold === !0 && (s === 1 ? o.nextFrame.addClass("animate-in") : s === -1 && o.nextFrame.toggleClass("animate-out animate-in"));
				};else if (r === "in") var u = function u() {
					o.afterNextFrameAnimatesIn();o._setHashTag();o.active = !1;if (!o.isHardPaused && !o.isBeingHoveredOver) if (!o.delayUnpause) o.unpause(!1);else {
						o.delayUnpause = !1;o.unpause();
					}
				};n.data("animationEnded", !1);t.bind(o.transitionEnd, function (r) {
					e(r.target).data("animationEnded", !0);var i = !0;n.each(function () {
						if (e(this).data("animationEnded") === !1) {
							i = !1;return !1;
						}
					});if (i) {
						t.unbind(o.transitionEnd);u();
					}
				});
			}, _setHashTag: function _setHashTag() {
				var t = this;if (t.settings.hashTags) {
					t.currentHashTag = t.nextFrame.prop(t.getHashTagFrom);t.frameHashIndex = e.inArray(t.currentHashTag, t.frameHashID);if (t.frameHashIndex !== -1 && (t.settings.hashChangesOnFirstFrame || !t.isStartingFrame || !t.transitionsSupported)) {
				...
				window.ModernizrForSequence = function (e, t, n) {
					function r(e) {
						...
						for (var r in e) {
							var i = e[r];if (!o(i, "-") && v[i] !== n) return t == "pfx" ? i : !0;
						}return !1;
					}function a(e, t, r) {
						for (var i in e) {
							var o = t[e[i]];if (o !== n) return r === !1 ? e[i] : s(o, "function") ? o.bind(r || t) : o;
						}return !1;
					}function f(e, t, n) {
						var r = e.charAt(0).toUpperCase() + e.slice(1),
						    i = (e + " " + b.join(r + " ") + r).split(" ");return s(t, "string") || s(t, "undefined") ? u(i, t) : (i = (e + " " + w.join(r + " ") + r).split(" "), a(i, t, n));
					}var l = "2.6.1",
					    c = {},
					    h = t.documentElement,
					    ...
					    k,
					    L = {}.hasOwnProperty,
					    A;!s(L, "undefined") && !s(L.call, "undefined") ? A = function A(e, t) {
						return L.call(e, t);
					} : A = function A(e, t) {
						return t in e && s(e.constructor.prototype[t], "undefined");
					}, Function.prototype.bind || (Function.prototype.bind = function (e) {
						var t = self;if (typeof t != "function") throw new TypeError();var n = C.call(arguments, 1),
						    r = function r() {
							if (self instanceof r) {
								var i = function i() {};i.prototype = t.prototype;var s = new i(),
								    o = t.apply(s, n.concat(C.call(arguments)));return Object(o) === o ? o : s;
						...
						if ((typeof e === "undefined" ? "undefined" : (0, _typeof3.default)(e)) == "object") for (var r in e) {
							A(e, r) && c.addTest(r, e[r]);
						} else {
							e = e.toLowerCase();if (c[e] !== n) return c;t = typeof t == "function" ? t() : t, enableClasses && (h.className += " " + (t ? "" : "no-") + e), c[e] = t;
						}return c;
			...
			}, _defaultPreloader: function _defaultPreloader(t, n, r) {
				var i = '<div class="sequence-preloader"><svg class="preloading" xmlns="http://www.w3.org/2000/svg"><circle class="circle" cx="6" cy="6" r="6" /><circle class="circle" cx="22" cy="6" r="6" /><circle class="circle" cx="38" cy="6" r="6" /></svg></div>';e("head").append("<style>.sequence-preloader{height: 100%;position: absolute;width: 100%;z-index: 999999;}@" + r + "keyframes preload{0%{opacity: 1;}50%{opacity: 0;}100%{opacity: 1;}}.sequence-preloader .preloading .circle{fill: #ff9442;display: inline-block;height: 12px;position: relative;top: -50%;width: 12px;" + r + "animation: preload 1s infinite; animation: preload 1s infinite;}.preloading{display:block;height: 12px;margin: 0 auto;top: 50%;margin-top:-6px;position: relative;width: 48px;}.sequence-preloader .preloading .circle:nth-child(2){" + r + "animation-delay: .15s; animation-delay: .15s;}.sequence-preloader .preloading .circle:nth-child(3){" + r + "animation-delay: .3s; animation-delay: .3s;}.preloading-complete{opacity: 0;visibility: hidden;" + r + "transition-duration: 1s; transition-duration: 1s;}div.inline{background-color: #ff9442; margin-right: 4px; float: left;}</style>");t.prepend(i);if (!ModernizrForSequence.svg && !n) {
					e(".sequence-preloader").prepend('<div class="preloading"><div class="circle inline"></div><div class="circle inline"></div><div class="circle inline"></div></div>');setInterval(function () {
